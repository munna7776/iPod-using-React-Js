...
class Ipod extends Component{
    ...
    changePageToHomeScreen = () => {
        ...
        if(this.state.activeItem === 'MyMusic' || this.state.activeItem === 'Artist'){
            this.setState({
                activeItem : 'Music',
                activePage : 'Home'
            })
                ...
                <div id='inner-container' style = {styles.wheel} onMouseOver={this.rotateWheel}>
                    ...
                    <div style = {styles.buttonContainer}>
                        <div style = {styles.middleButtons}>
                            ...
                            <div onClick={this.changePage} className="center-button" style={{backgroundImage: 'linear-gradient(45deg, #8c8181, transparent)' , width : '5rem' , height : '5rem' , borderRadius : '50%'}}>Select</div>
