                ...
                <div style={styles.menuList} id='menu-list'>
                    ...
                    <ListGroup style={{borderRadius:'0',fontFamily:'cursive'}}>
                        ...
                        <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='Game'?'active':''}>
                            Game {this.props.activeItem==='Game'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                        </ListGroup.Item>
                        ...
                        <ListGroup.Item style={{border:'0',padding: '0.2rem 0.6rem'}} className={this.props.activeItem==='Setting'?'active':''}>
                            Setting {this.props.activeItem==='Setting'?<span style={{float:'right' ,fontWeight:'bold'}}>&gt;</span>:''}
                        </ListGroup.Item>
                    </ListGroup>
                </div>
